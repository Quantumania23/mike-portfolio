...
//                 <Link href="/public/Curriculum vitaez.pdf" target={"_blank"}
//                 className="flex items-center bg-dark text-light p-2.5 px-6 
//                 rounded-lg text-lg font-semibold hover:bg-light hover:text-dark
//                 border-2 border-solid border-transparent hover:border-dark cursor-pointer
...
//                 </Link>
//                 <Link href="mailto:mikepeace981@gmail.com" target={"_blank"}
