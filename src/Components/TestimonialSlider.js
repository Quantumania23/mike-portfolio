...
import SwiperModules, { Navigation, Pagination, AutoPlay, Loop } from 'swiper';
...
const TestimonialSlider = () => {
  return (
    <Swiper
      ...
      loop ={true}
      modules={{Navigation, Pagination, AutoPlay, Loop}}
      className='h-[400px]'
    >
        ...
        return (
          <SwiperSlide key={index}>
            ...
            md:flex-row gap-x-8 h-full px-16'>
              ...
              <div className='w-full max-w-[300px] flex flex-col 2xl:justify-center xl:justify-center
              ...
              {/* quote & message */}
              <div className='flex-1 flex flex-col justify-center before:w-[1px] 2xl:before:bg-black/75
               xl:before:bg-black/75 xl:before:absolute xl:before:left-0 xl:before:h-[200px]
                relative xl:pl-20'>
                {/* quote icon */}
                <div className='mb-4'>
